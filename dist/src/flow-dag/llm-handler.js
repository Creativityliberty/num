...
export function createLLMHandler(provider = 'gemini', model) {
...
export const defaultLLMHandler = createLLMHandler(process.env.LLM_PROVIDER || 'gemini', process.env.LLM_MODEL || 'gemini-2.5-flash');
