import { z } from "zod";
export declare const PackFileEntrySchema: z.ZodObject<{
    path: z.ZodString;
    content: z.ZodString;
}, "strip", z.ZodTypeAny, {
    path?: string;
...
export declare const PackBundleSchema: z.ZodObject<{
...
export type PackFileEntry = z.infer<typeof PackFileEntrySchema>;
