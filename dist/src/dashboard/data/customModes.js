...
export function loadCustomModes(customModesDir) {
    const modes = [];
...
function parseYamlModes(content) {
    const modes = [];
...
function extractMultilineValue(block, key) {
...
export function getCustomModesStats(modes) {
    const byTag = {};
    const byCapability = {};
    let chefs = 0;
