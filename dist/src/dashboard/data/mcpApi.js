import { apiDesignFlowDefinition, codeReviewFlowDefinition, uxDesignFlowDefinition, } from '../../flow-dag/examples.js';
import { NumFlowOrchestrator, numflowPhase1Analysis, numflowPhase2Planning, numflowPhase3Solutioning, numflowPhase4Implementation, } from '../../flow-dag/numflow.js';
...
export async function handleMcpRequest(pathname, req, res) {
    // GET /mcp/tools
