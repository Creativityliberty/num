...
import { ModeFeedbackSchema, ModeStatsSchema, type ModeFeedback, type ModeStats } from "./feedback.schema.js";
...
export class FeedbackStore {
  ...
  async computeStats(modeId: string): Promise<ModeStats> {
  ...
  async computeAllStats(): Promise<ModeStats[]> {
    const all = await this.readAll();
