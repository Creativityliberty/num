...
import type { FlowDefinition, RunResult } from './runner.js';
...
export function setupMcpApi(app: Express) {
  ...
  app.get('/mcp/tools/:name', (req: Request, res: Response) => {
  ...
  app.get('/mcp/flows', (req: Request, res: Response) => {
  ...
  app.get('/mcp/flows/:id', (req: Request, res: Response) => {
  ...
  app.post('/mcp/flows/:id/simulate', (req: Request, res: Response) => {
    const flow = flowRegistry.get(req.params.id);
    if (!flow) {
      return res.status(404).json({ ok: false, error: 'Flow not found' });
    }
  ...
  app.post('/mcp/runs', (req: Request, res: Response) => {
  ...
  app.get('/mcp/runs', (req: Request, res: Response) => {
  ...
  app.get('/mcp/runs/:id', (req: Request, res: Response) => {
  ...
  app.get('/mcp/runs/:id/events', (req: Request, res: Response) => {
    const run = activeRuns.get(req.params.id);
    if (!run) {
      return res.status(404).json({ ok: false, error: 'Run not found' });
    }
