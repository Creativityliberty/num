...
export const apiDesignFlowDefinition: FlowDefinition = {
  id: 'api-design-flow',
...
export const codeReviewFlowDefinition: FlowDefinition = {
  id: 'code-review-flow',
...
export const uxDesignFlowDefinition: FlowDefinition = {
  id: 'ux-design-flow',
  name: 'UX Design Flow',
