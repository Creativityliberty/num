...
export class FlowDAGTestSuite {
  private testResults: Array<{ name: string; status: 'pass' | 'fail'; duration: number; error?: string }> = [];
  ...
  private async testStoreValidation(): Promise<void> {
  ...
  private async testSerialFlow(): Promise<void> {
  ...
  private async testParallelFlow(): Promise<void> {
  ...
  private async testNumFlowPhases(): Promise<void> {
  ...
  private recordTest(name: string, status: 'pass' | 'fail', duration: number, error?: string): void {
...
// Run tests
export async function runFlowDAGTests(): Promise<void> {
